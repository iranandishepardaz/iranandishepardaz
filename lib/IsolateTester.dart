...
//Source: https://vipinvijayannair.medium.com/performance-programming-in-flutter-using-isolates-part-1-afd43887e3b0
/*
      ...
      return () {
        setState(() {
          computeFuture = computeOnSecondaryIsolate().then((val) {
            showSnackBar(
                context, 'Secondary Isolate Done $val Loop Count: $count');
          });
        });
      };
    } else {
